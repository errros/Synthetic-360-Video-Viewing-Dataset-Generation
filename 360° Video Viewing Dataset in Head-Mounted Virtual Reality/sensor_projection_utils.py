...
#this utils has been tested on 360° Video Viewing Dataset in Head-Mounted Virtual Reality dataset
#this dataset comes in degrees values for angles
# yaw , pitch , roll have another definition in the dataset than in the utils here
#dataset has specific direction for coordinates
